  ...
  return {
    defaults: {
      ...
      mongoose: {
        ...
        uri: 'mongodb://localhost:27017/weallnet_comment',
    ...
    initialize: function (done) {
      sails.log.info(`Initializing custom hook (\`mongoose\`) at ${sails.config.mongoose.uri} with ${JSON.stringify(sails.config.mongoose.connectionOpts)}`);
      try {
